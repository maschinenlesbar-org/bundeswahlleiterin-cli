...
```
/plugin marketplace add maschinenlesbar-org/bundeswahlleiterin-cli
/plugin install bundeswahl@bundeswahl-skills
```

The first command registers the marketplace; the second installs the `bundeswahl`
